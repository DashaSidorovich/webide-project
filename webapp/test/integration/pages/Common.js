sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("lesson1sidorovich/lesson1sidorovich/app", ".html");
		...
		return Opa5.extend("lesson1sidorovich.lesson1sidorovich.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["lesson1sidorovich/lesson1sidorovich/localService/mockserver"], function (mockserver) {
